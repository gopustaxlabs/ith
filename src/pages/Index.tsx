...
const Index = () => {
  ...
  const paddingClass = isMobile ? "px-5" : "px-[100px]";

  return (
    <div className="bg-white flex flex-col overflow-hidden items-stretch">
      <Header />
      <div className="pt-[46px]"> {/* Space for fixed header */}
        <ProgressBar />
        <main className={`w-full max-w-[1266px] mt-[17px] ${paddingClass} max-md:max-w-full`}>
